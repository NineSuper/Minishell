...
NAME = minishell
SRC = main.c ft_pwd.c ft_env.c ft_cd.c parse.c ft_export.c ft_prompt.c ft_echo.c ft_cmds.c new_parse.c ft_reparg.c ft_redirect.c ft_unset.c new_parse_deux.c new_parse_trois.c
OBJ = $(SRC:.c=.o)
CC = gcc
